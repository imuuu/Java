...
public class subSpleefSpawnPositionCmd implements CommandInterface
{
	ImusMiniGames _main = null;

	String _subCmd = "";
	public subSpleefSpawnPositionCmd(ImusMiniGames main, String subCmd) 
	{
		_main = main;
		_subCmd=subCmd;
	}
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) 
    {
        ...
        String str_pos = ChatColor.GOLD + "Arena:  "+ChatColor.AQUA +arenaName + ChatColor.GOLD +" Added Spawnposition: "+ChatColor.DARK_PURPLE+(arena.getTotalSpawnPositions()+1);
