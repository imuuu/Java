...
public class CONSTANTS
{
	...
	public static final double NORMAL_CHANCE_1_TO_BE_TIER_2 = 0.10;
	//public static final double MEDIUM_CHANCE_1_TO_BE_TIER_2 = 28;
	public static final double HIGH_CHANCE_1_TO_BE_TIER_2 = 0.65;
	
	//public static final double NORMAL_CHANCE_2_TO_BE_TIER_3 = 10;
	//public static final double MEDIUM_CHANCE_2_TO_BE_TIER_3 = 28;
	public static final double HIGH_CHANCE_2_TO_BE_TIER_3 = 0.60;
	...
	public static final double BUY_MORE_LIKE_TOOL_CHANCE = 0.7f;
	public static final double BUY_MORE_LIKE_ARMOR_CHANCE = 0.7f;
	public static final double BUY_MORE_LIKE_TOOL_TO_BE_TOOL_CHANCE = 0.65f;
