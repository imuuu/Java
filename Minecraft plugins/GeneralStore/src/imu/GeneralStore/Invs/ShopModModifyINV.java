...
import imu.GeneralStore.Prompts.ConvPromptAmount;
		...
		{			
			...
			if(e.getClick() == ClickType.LEFT)
			{
				...
				case CUSTOM_AMOUNT:
					...
					conv = cf.withFirstPrompt(new ConvPromptAmount(_main, _player, orginal_item, _shop,_answers, slot,question)).withLocalEcho(true).buildConversation(_player);
					conv.begin();
